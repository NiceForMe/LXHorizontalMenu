...
- (void)setNeedConstraint:(BOOL)needConstraint
{
    ...
    if (needConstraint == YES) {
        [_topMenu mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.left.equalTo(self);
            make.size.mas_equalTo(CGSizeMake(self.topMenuSize.width, self.topMenuSize.height));
        }];
        [_rootMenu mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)addSeparatorLine
{
    ...
    [sepLine mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.equalTo(self.topMenu);
        ...
        if (rootView != nil) {
            if (rootCell.contentView.subviews.count == 0) {
                ...
                [rootView mas_makeConstraints:^(MASConstraintMaker *make) {
                    make.top.left.right.bottom.equalTo(rootCell.contentView);
                }];
