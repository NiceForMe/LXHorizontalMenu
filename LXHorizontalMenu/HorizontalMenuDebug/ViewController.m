...
@interface ViewController ()<LXHorizontalMenuDataSource,UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)initMenu
{
    LXHorizontalMenu *menu = [[LXHorizontalMenu alloc]initWithFrame:CGRectZero topMenuSize:CGSizeMake(MenuWidth - 50, 50) type:LXHorizontalMenuCommonType];
    ...
    menu.scrollType = LXHorizontalMenuScrollTypeNoneAuto;
    menu.canScroll = NO;
    self.menu = menu;
